...
public class TempConsultor extends FuncionarioTemp {
    ...
    public TempConsultor(String nome, String sobrenome, String cpf, String email, String dataInicioContrato, String terminoContrato, int valorContrato, int numRelatorios, CLTPleno consultor) {
