...
public class CLT extends Funcionario{
    ...
    public CLT(String nome, String sobrenome, String cpf, Set<String> email, String dataInicioContrato, int salario, int cargaHoraria, int numeroCarteiraTrabalho, Set<String> habilidades) {
